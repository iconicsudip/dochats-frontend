...
import { Layout, Input, Avatar, Typography, Spin, Button, Space, Select } from 'antd';
import { SendOutlined, SmileOutlined, PaperClipOutlined, MoreOutlined, SearchOutlined, MessageOutlined, CheckOutlined, AudioOutlined, FilterOutlined, CloseOutlined } from '@ant-design/icons';
...
const LiveChat: React.FC = () => {
    ...
    return (
        <Layout style={{ height: 'calc(100vh - 120px)', background: 'var(--wa-bg)', overflow: 'hidden', border: '1px solid var(--divider)', borderRadius: 4 }}>
            <Sider width={400} style={{
                ...
                <div style={{
                    ...
                    <Avatar src="https://api.dicebear.com/7.x/avataaars/svg?seed=Admin" style={{ border: '1px solid rgba(255,255,255,0.1)' }} />
                                    ...
                                    <div style={{ flex: 1, overflow: 'hidden' }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 2 }}>
                                            <Text strong={conv.unreadCount > 0} ellipsis style={{ color: '#fff', fontSize: 16 }}>
                                                {conv.visitorName ? `${conv.visitorName} (${conv.visitorPhone})` : `User ${conv.visitorToken.substring(0, 8)}`}
                                            </Text>
            ...
            <Content style={{
                ...
                {selectedId ? (
                    <>
                        ...
                        <div style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
                                <Avatar size={40} src={`https://api.dicebear.com/7.x/bottts/svg?seed=${selectedConv?.visitorToken}`} style={{ background: '#6a7175' }} />
                                <div>
                                    <div style={{ color: '#fff', fontSize: 16, fontWeight: 600 }}>
                                        {selectedConv?.visitorName ? `${selectedConv.visitorName} (${selectedConv.visitorPhone})` : `User ${selectedConv?.visitorToken.substring(0, 12)}...`}
                                    </div>
                                            ...
                                            {dateMsgs.map((msg: any) => {
                                                return (
                                                    <div
                                                        ...
                                                        style={{ marginBottom: 16, animation: 'fadeIn 0.3s' }}
                        ...
                        <div style={{ position: 'relative', zIndex: 10 }}>
                            ...
                            <div style={{
                                ...
                                <Space size={20} style={{ color: 'var(--wa-secondary)', fontSize: 24 }}>
                                    <SmileOutlined
                                ...
                                {showEmoji && (
                                    <div style={{ position: 'absolute', bottom: 70, left: 16 }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', zIndex: 10 }}>
                        ...
                        <Title level={4} style={{ color: '#fff', opacity: 0.8, marginBottom: 8 }}>WhatsApp for Web</Title>
