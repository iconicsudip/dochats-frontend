...
const Email: React.FC = () => {
    ...
    return (
        <div className="pb-20 animate-in fade-in duration-500 font-sans w-full min-w-0 text-slate-800">
            ...
            {/* Custom Tabs */}
            <div className="flex gap-1 sm:gap-2 mb-6 bg-slate-200/60 p-1 sm:p-1.5 rounded-2xl w-full overflow-x-auto border border-slate-200/60">
                <button 
                    onClick={() => setActiveTab('templates')}
                    className={cn(
                        "flex-1 flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-6 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all whitespace-nowrap cursor-pointer shrink-0",
                        activeTab === 'templates' 
                ...
                >
                    ...
                    <span className="hidden sm:inline">Sender </span>Identity
                </button>
            </div>
